...
//| e1 = expression {$exprRet = new CommaExpr($e1.exprRet); $e1.exprRet.notFirst();} (c = Comma e =
// expression {$exprRet.addExpr($e.exprRet); $e.exprRet.notFirst(); $exprRet.setLine($c.line);})+ ;
// // Comma operator az in be paiin class zadam
